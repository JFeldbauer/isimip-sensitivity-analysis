...
# load results
folder = "../data/"
results_df = pd.read_csv(folder+'results_lhc_revision.csv')
...
pars_gotm = ['wind_speed', 'swr', 'bottom.h0b',
             'turb_param.const_num', 'Kw', 'dummy']
pars_simstrat = ['wind_speed', 'swr', 'hgeo',
                 'cd', 'Kw', 'dummy']
...
# write to file
res.to_csv('res_sens_revised.csv', index=False)
